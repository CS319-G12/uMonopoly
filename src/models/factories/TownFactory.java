...
public class TownFactory implements PropertyFactory {
    ...
    public Set<TownSquare> makeSquares() {
        ...
        TownCard card2 = new TownCard(1, "BALTIC AVENUE", Color.BROWN, 60, 30, 4, 20, 60, 180, 320, 450, 50, 50);
        TownCard card3 = new TownCard(3, "ORIENTAL AVENUE", Color.LIGHT_BLUE, 100, 50, 6, 30, 90, 270, 400, 550, 50, 50);
        TownCard card4 = new TownCard(4, "VERMONT AVENUE", Color.LIGHT_BLUE, 100, 50, 6, 30, 90, 270, 400, 550, 50, 50);
        TownCard card5 = new TownCard(5, "CONNECTICUT AVENUE", Color.LIGHT_BLUE, 120, 60, 8, 40, 100, 300, 450, 600, 50, 50);
        TownCard card6 = new TownCard(6, "ST. CHARLES PLACE", Color.PINK, 140, 70, 10, 50, 150, 450, 625, 750, 100, 100);
        TownCard card7 = new TownCard(8, "STATES AVENUE", Color.PINK, 140, 70, 10, 50, 150, 450, 625, 750, 100, 100);
        TownCard card8 = new TownCard(9, "VIRGINIA AVENUE", Color.PINK, 160, 80, 60, 12, 180, 500, 700, 900, 100, 100);
        TownCard card9 = new TownCard(11, "ST. JAMES PLACE", Color.ORANGE, 180, 90, 14, 70, 200, 500, 750, 950, 100, 100);
        TownCard card10 = new TownCard(12, "TENNESSEE AVENUE", Color.ORANGE, 180, 90, 14, 70, 200, 550, 750, 950, 100, 100);
        TownCard card11 = new TownCard(13, "NEW YORK AVENUE", Color.ORANGE, 200, 100, 16, 80, 220, 600, 800, 1000, 100, 100);
        TownCard card12 = new TownCard(14, "KENTUCKY AVENUE", Color.RED, 220, 110, 18, 90, 250, 700, 875, 1050, 150, 150);
        TownCard card13 = new TownCard(15, "INDIANA AVENUE", Color.RED, 220, 110, 18, 90, 250, 700, 875, 1050, 150, 150);
        TownCard card14 = new TownCard(16, "ILLINOIS AVENUE", Color.RED, 240, 120, 20, 100, 300, 750, 925, 1100, 150, 150);
        TownCard card15 = new TownCard(18, "ATLANTIC AVENUE", Color.YELLOW, 260, 130, 22, 110, 330, 800, 975, 1150, 150, 150);
        TownCard card16 = new TownCard(19, "VENTNOR AVENUE", Color.YELLOW, 260, 130, 22, 110, 330, 800, 975, 1150, 150, 150);
        TownCard card17 = new TownCard(21, "MARVIN GARDENS", Color.YELLOW, 280, 140, 24, 120, 360, 850, 1025, 1200, 150, 150);
        TownCard card18 = new TownCard(22, "PACIFIC AVENUE", Color.GREEN, 300, 150, 26, 130, 390, 900, 1100, 1275, 150, 150);
        TownCard card19 = new TownCard(23, "NORTH CAROLINA AVENUE", Color.GREEN, 300, 150, 26, 130, 390, 900, 1100, 1275, 200, 200);
        TownCard card20 = new TownCard(24, "PENNSYLVANIA AVENUE", Color.GREEN, 320, 160, 28, 150, 450, 1000, 1200, 1400, 200, 200);
        TownCard card21 = new TownCard(26, "PARK PLACE", Color.BLUE, 350, 175, 35, 175, 500, 1100, 1300, 1500, 200, 200);
        TownCard card22 = new TownCard(27, "BOARDWALK", Color.BLUE, 400, 200, 50, 200, 600, 1400, 1700, 2000, 200, 200);
