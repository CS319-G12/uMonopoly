...
public class HelpController {
    ...
    public HelpController() {
        ...
        HelpItem item4 = new HelpItem("THE BANK", "the Bank\n" +
                ...
                "and use by the players, pays salaries and bonuses and sells\n" +
        ...
        HelpItem item7 = new HelpItem("BUYING PROPERTY", "Whenever you land on an unowned property you\n" +
        ...
        HelpItem item8 = new HelpItem("PAYING RENT", "When you land on property owned by another player, the owner collects rent from you in " +
                "accordance with the list printed on its Title Deed card.");

        HelpItem item9 = new HelpItem("CHANCE AND COMMUNITY CHEST", " When you land on either of\n" +
        ...
        HelpItem item10 = new HelpItem("INCOME TAX", "If you land here you have two options: You may\n" +
